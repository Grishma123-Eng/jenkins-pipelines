    ...
    library changelog: false, identifier: "lib@add-ps-90-pt-support", retriever: modernSCM([
        $class: 'GitSCMSource',
    ...
    parameters {
        choice(
            choices: ['ps_80', 'ps_84','ps-9x-innovation-lts' ,'ps_lts_innovation','client_test'],
            description: 'Choose the product version to test: PS9X_innovation_lts OR ps_lts_innovatoin',
