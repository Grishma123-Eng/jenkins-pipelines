library changelog: false, identifier: "lib@site-checks-fix", retriever: modernSCM([
    $class: 'GitSCMSource',
...
def operatingsystems() {
    return ['oracle-9','ubuntu-jammy', 'ubuntu-noble', 'al-2023' , 'debian-11', 'debian-12', 'debian-13']
}
