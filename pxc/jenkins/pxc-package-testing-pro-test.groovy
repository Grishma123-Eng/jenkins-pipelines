...
void setInventories(String param_test_type){
                    ...
                    if(("${params.node_to_test}" == "ubuntu-noble") || ("${params.node_to_test}" == "ubuntu-focal") || ("${params.node_to_test}" == "ubuntu-jammy") || ("${params.node_to_test}" == "ubuntu-noble-arm") || ("${params.node_to_test}" == "ubuntu-jammy-arm")){
                        ...
                        SSH_USER="admin"
                    }else if(("${params.node_to_test}" == "ol-8") || ("${params.node_to_test}" == "ol-9") || ("${params.node_to_test}" == "min-amazon-2") || ("${params.node_to_test}" == "rhel-8") || ("${params.node_to_test}" == "amazon-linux-2023") || ("${params.node_to_test}" == "amazon-linux-2023-arm") || ("${params.node_to_test}" == "rhel-9") ("${params.node_to_test}" == "rhel-8-arm") || ("${params.node_to_test}" == "rhel-9-arm")){
                        SSH_USER="ec2-user"
                    }else{
...
def setup(){
                ...
                installMoleculeBookworm()
                    sh '''
                        ...
                        git clone https://github.com/Grishma123-Eng/package-testing --branch pxc-final
                    '''
}
